...
void Check_in_map(const std::string&, const std::string& file_path, std::unordered_map<std::string, std::string>& md5_container, std::unordered_set<std::string>& repeat_set);
...
void Check_in_map(const std::string& true_md5_str, const std::string& file_path, std::unordered_map<std::string, std::string>& md5_container, std::unordered_set<std::string>& repeat_set){
    std::unordered_map<std::string, std::string>::iterator pt = md5_container.find(true_md5_str);
